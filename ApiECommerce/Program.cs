...
// Habilita suporte a XML para que endpoints com [Consumes("application/xml")] aceitem XML via Swagger
...
builder.Services.AddHttpClient(); // ✅ isso habilita o IHttpClientFactory

builder.Services.AddCors(options =>
{
    options.AddPolicy("AllowBlazorApp",
        policy => policy.WithOrigins(
            "https://allanviniciussouza.github.io", 
            "https://localhost:7245") // <- coloque a porta real do seu Blazor
                        .AllowAnyMethod()
                        .AllowAnyHeader());
});
